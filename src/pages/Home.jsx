    ...
    <div>
      ...
      <div style={{ 
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <Paragraph style={{ 
            ...
            基于 React、Express 和 MySQL 构建的高性能博客平台。支持服务端渲染、智能缓存、
            AI 写作助手和优雅降级方案。
          </Paragraph>
          <Space size="large">
            <Button 
            ...
            >
              <Link to="/articles" style={{ color: 'white' }}>浏览文章</Link>
            </Button>
            <Button 
              size="large" 
              icon={<EditOutlined />}
      ...
      <div style={{ padding: '80px 50px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <Title level={2} style={{ textAlign: 'center', marginBottom: '60px', color: '#1f2329' }}>
            核心特性
          </Title>
      ...
      <div style={{ 
        ...
        <Paragraph type="secondary">
          © {new Date().getFullYear()} SSR 博客系统 - 基于 React、Express 和 MySQL 构建
        </Paragraph>
      </div>
    </div>
  );
